<?php
  ...
  function navaid_ident ( array $navaid ) {
    return '<morse>' . __morse( $navaid[ 'ident' ] ) . '</morse>';
  }

  function navaid_level ( array $navaid ) {
    return i18n( 'level-' . $navaid[ 'level' ] );
  }

  function navaid_power ( array $navaid ) {
    return i18n( 'power-' . $navaid[ 'power' ] );
  }

  function navaid_list ( array $airport, array $navaids ) {
  ...
  function _navaid_list ( array $airport, array $navaids ) {
    echo navaid_list( $airport, $navaids );
  }

  function waypoint_list ( array $airport, array $waypoints ) {
  ...
  function _waypoint_list ( array $airport, array $waypoints ) {
