<?php
  ...
  if (
    empty( $airport = airport_by( 'ICAO', $path[ 1 ] ?? '' ) ) ||
  ...
  if ( $image = airport_image( $airport[ 'ICAO' ] ) ) $__site_img = $image[ 'url' ];
  ...
  if ( $airport[ 'home' ] ) $tabs[] = [
    'i18n' => 'link-home',
    'external' => $airport[ 'home' ]
  ];

  if ( $wiki = airport_wiki( $airport[ 'ICAO' ] ) ) $tabs[] = [
    'i18n' => 'link-wiki',
