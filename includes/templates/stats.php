<?php
  ...
  function _stats_grid ( array $raw = [] ) {

    $boxes = [];

    foreach ( $raw as $row ) $boxes[] = '<div class="stats-box">
...
<div class="content-full stats">
  ...
  <div class="stats-section">
    ...
    <?php _stats_grid( [ [
      ...
      'value' => [ __number( AIRPORT_ALL ) ]
    ], [
      'icon' => 'flight_takeoff',
      'label' => i18n( 'stats-active-runways' ),
      'value' => [ __number( $DB->query( '
  ...
  <div class="stats-section">
    ...
    <?php _stats_grid( [ [
      ...
      'value' => [ __number( AIRPORT_STATS[ 'large' ] ) ]
    ], [
      'icon' => 'airplane_ticket',
      'label' => i18n( 'airport-typep-medium' ),
      'value' => [ __number( AIRPORT_STATS[ 'medium' ] ) ]
    ], [
      'icon' => 'flight',
      'label' => i18n( 'airport-typep-small' ),
      'value' => [ __number( AIRPORT_STATS[ 'small' ] ) ]
    ], [
      'icon' => 'mode_fan',
      'label' => i18n( 'airport-typep-heliport' ),
      'value' => [ __number( AIRPORT_STATS[ 'heliport' ] ) ]
    ], [
      'icon' => 'anchor',
      'label' => i18n( 'airport-typep-seaplane' ),
      'value' => [ __number( AIRPORT_STATS[ 'seaplane' ] ) ]
    ], [
      'icon' => 'landscape',
      'label' => i18n( 'airport-typep-altiport' ),
      'value' => [ __number( AIRPORT_STATS[ 'altiport' ] ) ]
    ], [
      'icon' => 'public',
      'label' => i18n( 'airport-resp-public' ),
      'value' => [ __number( $res_count[ 'public' ] ) ]
    ], [
      'icon' => 'military_tech',
      'label' => i18n( 'airport-resp-military' ),
      'value' => [ __number( $res_count[ 'military' ] + $res_count[ 'joint_use' ] ) ]
    ], [
      'icon' => 'lock_open',
      'label' => i18n( 'airport-resp-private' ),
      'value' => [ __number( $res_count[ 'private' ] ) ]
    ] ] ); ?>
  </div>
</div>
<?php _footer(); ?>
